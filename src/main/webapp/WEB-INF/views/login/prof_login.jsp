...
<body>
	...
	<section>
		...
		<form action="prof_main" method="get">
			<div id="login_box">
				<h2>LOGIN</h2>
				<ul id="input_button">
					<li id="id_pass">
						<ul>
							<li id="id"><span style="font-size: 14px;">교수번호</span> <input
								type="text" name="HAKBUN" style="width: 180px; height: 20px;">
							</li>
							<!-- id -->
							<li id="pass"><span style="font-size: 14px;">PW</span> <input
								type="password" name="HAK_PW"
