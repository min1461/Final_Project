...
<form action="adm_main" method="post"> <!-- 로그인 폼 부분  -->
      ...
      <li id="id_pass">
        ...
        <ul>
          ...
          <li id="id">
            ...
            <input type="text" name="ADMBUN" style="width:180px;height:20px; ">
          ...
          <li id="pass">    
            ...
            <input type="password" name="ADM_PW" style="width:180px;height:20px;">            
