...
<div class="container">
	<div class="row">
		<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; width:100%;">
			...
			<tbody>
			<c:forEach var="admingongbo" items="${admingongbo1}">
				<tr>
					<td style="width: 20%; border:1px solid #dddddd;">제목</td>
					<td colspan="2" style="border:1px solid #dddddd;">${admingongbo.TITLE}</td>
				</tr>
				<tr>
					<td style="border:1px solid #dddddd;">작성자</td>
					<td colspan="2" style="border:1px solid #dddddd;">${admingongbo.WRITER}</td>
				</tr>
				<tr>
					<td style="border:1px solid #dddddd;">작성일</td>
					<td colspan="2" style="border:1px solid #dddddd;">${admingongbo.WRITERDAY}</td>
				</tr>
				<tr>
					<td style="border:1px solid #dddddd;">내용</td>
					<td colspan="2" style="height: 400px; border:1px solid #dddddd; text-align:left;">${admingongbo.CONTENT}</td>
				</tr>
				</c:forEach>
			</tbody>
		</table>
