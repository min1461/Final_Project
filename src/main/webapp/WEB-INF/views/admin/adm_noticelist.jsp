...
<body>
		...
		<c:forEach var="nl" items="${nlist1}">
			<tr>
				...
				<td><a href="javascript:void(0);"
					onclick="btnclick('adm_noticeCheck?ANN_NUM=${nl.ANN_NUM}')">${nl.ANN_TITLE}</a></td>
				<td>${nl.ADM_NAME}</td>
	...
	<button class="button" href="javascript:void(0);"
		onclick="btnclick('adm_noticeInsert')">글쓰기</button>
	...
	<script type="text/javascript">
		...
		alert(choice2); */
			...
			$.ajax({
				...
				//datatype : 'text',//Ajax를 통해 호출한 페이지의 Return 형식이다. 형식에 따라 xml, json, html, text 등을 사용하면 됨
