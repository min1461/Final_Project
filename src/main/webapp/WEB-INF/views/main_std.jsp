...
<body>
	...
	<div id="side_page">
		...
		<div class="dropdown">
			<button class="dropbtn" href="javascript:void(0);" onclick="btnclick('index.jsp')"><img src="./resources/img/arrow_blue_circle.png"> </a>공지사항</button>
		</div>
		...
		<div class="dropdown">
			...
			<div id="myDropdown3" class="dropdown-content">
				...
				<a href="javascript:void(0);" onclick="btnclick('B.jsp')"><img src="./resources/img/arrow_red.png"> 결제</a></li>
			</div>
		</div>
