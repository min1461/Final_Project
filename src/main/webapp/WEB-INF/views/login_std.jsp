...
<nav> <img src="./resources/img/logo.png" alt="로고타이틀">
  ...
  <div id="login_box">
    ...
    <ul id="input_button">
      <li id="id_pass">
        <ul>
          <li id="id">
            <span style="font-size:14px;">학번</span>
            <input type="text" name="HAKBUN" id="HAKBUN" style="width:180px;height:20px; ">
          </li> <!-- id -->
          <li id="pass">    
            <span style="font-size:14px;">PW</span>
            <input type="password" name="HAK_PW" id="HAK_PW" style="width:180px;height:20px;">            
          </li> <!-- pass -->
        </ul>
      </li>
      <li id="login_btn">
        <button type="button" id="submit"><b>로그인</b></button>
