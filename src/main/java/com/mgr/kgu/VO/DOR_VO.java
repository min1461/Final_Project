...
public class DOR_VO {
	...
	public String getDOR_PARN() {
		return DOR_PARN;
	}



	public void setDOR_PARN(String dOR_PARN) {
		DOR_PARN = dOR_PARN;
	}
